...
final class KeyResponder {
	...
	public function maybe_output(): void {
		...
		// IndexNow requires the response body to be the raw key, no escaping.
		// Key is constrained at save time by Settings::sanitize() to ^[a-zA-Z0-9-]+$.
		echo $key; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- IndexNow protocol; see comment above.
		exit;
	}
