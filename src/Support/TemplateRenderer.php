...
final class TemplateRenderer {
	...
	public static function render( string $relative_path, array $data = array(), ?callable $sanitizer = null ): void {
		echo self::get( $relative_path, $data, $sanitizer ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- self::get() applies wp_kses() with self::allowed_tags() before returning.
	}
