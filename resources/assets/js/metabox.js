const initAirygenMetabox = () => {
  if (!document.querySelector('#airygen-metabox')) {
    return;
  }
  ...
  const title = document.querySelector('#airygen-title');
  const description = document.querySelector('#airygen-description');
